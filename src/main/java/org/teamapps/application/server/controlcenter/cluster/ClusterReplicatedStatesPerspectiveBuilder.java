...
public class ClusterReplicatedStatesPerspectiveBuilder extends AbstractPerspectiveBuilder {

	public ClusterReplicatedStatesPerspectiveBuilder() {
		super("clusterReplicatedStatesPerspective", ApplicationIcons.SPREADSHEET_DATA, "cluster.replicatedStates", "cluster.replicatedStates.desc");
	}
