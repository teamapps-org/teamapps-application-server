...
public class ComboBoxUtils {
	...
	public static <RECORD> ComboBox<RECORD> createRecordComboBox(List<RECORD> records, PropertyProvider<RECORD> propertyProvider, Template template) {
		...
		Function<RECORD, String> recordToStringFunction = record -> (String) propertyProvider.getValues(record, Collections.singleton(BaseTemplate.PROPERTY_CAPTION)).get(BaseTemplate.PROPERTY_CAPTION);
